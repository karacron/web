	...
	return (
		<div
			...
			<div className='mx-auto max-w-7xl py-16 sm:px-6 sm:py-20 lg:px-8 '>
				<div className='relative isolate overflow-hidden bg-gray-800 px-6 pt-12 after:pointer-events-none  sm:rounded-3xl sm:px-16 after:sm:rounded-3xl md:pt-16 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0'>
